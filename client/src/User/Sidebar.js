...
import { faFile, faTrash, faUser, faStar, faSignOutAlt, faEnvelope, faRobot } from '@fortawesome/free-solid-svg-icons';
          ...
          <ul>
            ...
            </li>
            {
              userData?.role === 'user_plus' && (
                <li>
                  <Link to="/aiPrompt">
                    <FontAwesomeIcon icon={faRobot} className="fa-icon" /> AI Prompt
                  </Link>
                </li>
              )
            }
