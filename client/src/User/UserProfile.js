    ...
    <div>
      ...
      <div className="userProfileContainer">
        ...
        >
          ...
          <ColorButton onClick={handleUpdate} variant="contained">
            Update Info
          </ColorButton>
          ...
          <ColorButton onClick={handlePasswordUpdate} variant="contained">
            Change Password
          </ColorButton>
        </Box>
        ...
        >
          <ColorButtonDelete onClick={handleDeleteAccount} variant="contained">
            Delete Account
          </ColorButtonDelete>
        </Box>
      </div>
